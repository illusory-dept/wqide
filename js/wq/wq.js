 ...
 * @returns {Promise<any>}
 */
export function run_wasm(code, opts) {
    const ptr0 = passStringToWasm0(code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.run_wasm(ptr0, len0, opts);
    return ret;
}
...
export class WqSession {
     ...
     */
    push_stdin(lines) {
        wasm.wqsession_push_stdin(this.__wbg_ptr, lines);
    }
    /**
     * @param {any} stdout
     */
    set_stdout(stdout) {
        wasm.wqsession_set_stdout(this.__wbg_ptr, stdout);
    }
    /**
     * @param {any} stderr
     */
    set_stderr(stderr) {
        wasm.wqsession_set_stderr(this.__wbg_ptr, stderr);
    }
    /**
     * @param {string} code
     * @param {any} opts
    ...
    eval(code, opts) {
        const ptr0 = passStringToWasm0(code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wqsession_eval(this.__wbg_ptr, ptr0, len0, opts);
        return ret;
    }
    /**
     * @param {number} n
     ...
     */
    set_box_mode() {
        const ret = wasm.wqsession_set_box_mode(this.__wbg_ptr);
        return ret !== 0;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wq_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
